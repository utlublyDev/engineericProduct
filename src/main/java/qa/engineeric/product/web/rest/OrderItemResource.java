...
import qa.engineeric.product.service.OrderItemService;
...
/**
 * REST controller for managing {@link qa.engineeric.product.domain.OrderItem}.
 */
@RestController
@RequestMapping("/api")
public class OrderItemResource {
    ...
    public ResponseEntity<OrderItem> updateOrderItem(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, orderItem.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<OrderItem> partialUpdateOrderItem(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, orderItem.getId())
        );
    }
